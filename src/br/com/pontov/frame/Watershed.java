...
public class Watershed {
	...
	Mat goldimgc = Highgui.imread("/Users/alexandrermello/Documents/GoldenImages/PCB_ID15V0/GoldenImages/Img4Defect0a.png");
...
//---------------------VETORES E MOMENTOS1--------------------------------
      if (key == false)
      {
       ...
       for( int i = 0; i< contours.size(); i++ )
       {
         ...
         Core.circle(markers, mc.get(i), 4, new Scalar(255,0,0), 3,0, 0); //4
              }
       }
     ...
     //---------------------VETORES E MOMENTOS2--------------------------------
       ...
       for( int i = 0; i< contours.size(); i++ )
       {
         ...
         Core.circle(markers, mc2.get(i), 4, new Scalar(255,0,0), 3,0, 0); //4
              }
       }
   ...
   //ELLIPSE FIT----------------------------------------------------------------------------------------           
    ...
    // Core.ellipse(drawing, elip, new Scalar(255,0,0));
     Core.ellipse(markers, rectrot, new Scalar(255,0,0), 1);
