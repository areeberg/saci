...
public class Features {
	...
	public void findContour()
	{
	        ...
	        goldimagecropped = Highgui.imread(arr.getURL2(), Imgproc.COLOR_BGR2GRAY);  //entrada da classe
...
/*	        Imshow dra4 = new Imshow("Drawing4");
	    ...
	    //--------------VETORES E MOMENTO 1
	        ...
	        if (key==false)
	        {
	        	 arr.setContour(largest_contour);
 ...
 //--------------VETORES E MOMENTO 2
	        ...
	        if (key==true)
	        {
	        	 arr.setContour(largest_contour+largest_contour2);
